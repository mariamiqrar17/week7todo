    ...
    <Draggable draggableId={todoObj.id.toString()} index={todoObj.id}>
      {(provided) => (
        <div
          ...
          className="todo bg-white shadow-sm rounded grid grid-cols-2 py-5 px-5 my-3 cursor-pointer hover:shadow-lg hover:scale-105 transition-all ease duration-500"
        >
